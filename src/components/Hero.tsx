            ...
            <div className="rounded-3xl bg-white/95 dark:bg-[#090E1E]/95 border border-slate-200/90 dark:border-white/10 p-5 shadow-sm">
              ...
              <div className="flex items-center justify-between pb-3 mb-3 border-b border-slate-100 dark:border-white/[0.06]">
                ...
                <button
                  ...
                  className={`px-2.5 py-1 rounded-full transition-all cursor-pointer flex items-center gap-1.5 text-[10.5px] font-mono font-bold ${
                    isPlayingAudio
                      ? "bg-gradient-to-r from-purple-500/20 via-orange-500/20 to-indigo-500/20 border border-[#AD5CFF]/50 text-[#AD5CFF] shadow-sm shadow-purple-500/20"
                      : "bg-slate-100 dark:bg-white/[0.06] hover:bg-slate-200 dark:hover:bg-white/[0.12] text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-white/10"
                  }`}
                  title={isPlayingAudio ? "Disable Ambience Mode" : "Activate Celebration Ambience Mode"}
                >
                  {isPlayingAudio ? (
                    <>
                      <div className="flex items-center gap-0.5 h-3">
                        <span className="w-0.5 h-2.5 bg-gradient-to-t from-[#AD5CFF] to-[#FF9900] rounded-full animate-pulse" />
