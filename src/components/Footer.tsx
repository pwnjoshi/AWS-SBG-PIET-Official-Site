...
export default function Footer() {
  return (
    <footer className="relative bg-[#03050C] border-t border-white/[0.08] pt-14 pb-10 px-4 sm:px-6 lg:px-8 z-10">
      <div className="max-w-6xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 pb-10 border-b border-white/[0.06]">
          {/* Brand Col */}
          <div className="lg:col-span-5 flex flex-col gap-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-mono font-semibold px-2 py-0.5 rounded bg-[#AD5CFF]/15 text-[#BE7BFF] border border-[#AD5CFF]/25">
                PANIPAT 2026
              </span>
            </div>
          ...
          <div className="lg:col-span-4 flex flex-col gap-2">
            ...
            <p className="text-xs text-slate-400 leading-relaxed">
              Organized by <span className="text-white font-medium">AWS Student Builder Group PIET</span> in collaboration with regional student community leaders, AWS Heroes, and Community Builders.
            </p>
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-[11px] text-slate-500">
          ...
          <p className="font-mono text-[10px] text-[#BE7BFF]">
