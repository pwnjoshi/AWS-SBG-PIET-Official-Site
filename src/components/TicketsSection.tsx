  ...
  return (
    <section id="tickets" className="relative py-24 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto z-10">
        ...
        {TICKET_TIERS.map((tier, index) => {
          return (
            <motion.div
              ...
              className={`rounded-2xl p-6 flex flex-col justify-between transition-colors border ${
                tier.popular
                  ? "bg-[#100E2C] border-[#AD5CFF] shadow-xl shadow-[#AD5CFF]/15"
                  : "bg-[#090E1E] border-white/[0.08] hover:border-white/20"
              }`}
            >
              <div>
                ...
                <p className="text-xs text-slate-400 font-medium mb-4">{tier.forWhom}</p>

                <p className="text-xs text-slate-300 pb-4 mb-4 border-b border-white/[0.06] leading-relaxed">
                  {tier.description}
                </p>
                ...
                <div className="space-y-2.5 mb-6">
                  {tier.features.map((feature) => (
                    <div key={feature} className="flex items-start gap-2 text-xs text-slate-200">
              ...
              <button
                ...
                className={`w-full py-2.5 rounded-xl font-bold text-xs transition-all flex items-center justify-center gap-1.5 hover:scale-[1.02] ${
                  tier.popular
      ...
      <motion.div
        ...
        className="rounded-2xl bg-[#070B1A] border border-white/10 p-6 sm:p-8"
      >
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <form onSubmit={handleGeneratePass} className="space-y-3 mt-1">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-3.5 py-2 rounded-lg bg-[#04060E] border border-white/10 text-white text-xs focus:border-[#AD5CFF] focus:outline-none"
                />
              </div>
              ...
              <div className="flex gap-2 pt-1">
                <button
                  type="submit"
                  className="px-4 py-2 rounded-lg bg-white/[0.08] hover:bg-white/[0.14] text-white text-xs font-semibold border border-white/10 transition-all hover:scale-[1.02]"
                >
                  Generate Badge ID
                </button>
                <button
                  ...
                  className="px-4 py-2 rounded-lg bg-[#AD5CFF] hover:bg-[#BE7BFF] text-white text-xs font-bold transition-all flex items-center gap-1 shadow-md shadow-[#AD5CFF]/25 hover:scale-[1.02]"
                >
          ...
          <div className="lg:col-span-6 flex justify-center">
            <motion.div
              ...
              className="w-full max-w-sm rounded-xl bg-[#04060E] border border-[#AD5CFF]/30 p-5 shadow-2xl shadow-[#AD5CFF]/10 perspective-1000"
            >
